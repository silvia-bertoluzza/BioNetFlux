...
# Default problem module (Keller-Segel)
setup = SolverSetup()

# Custom problem module
setup = SolverSetup("bionetflux.problems.reduced_ooc_problem")

# OrganOnChip problem
setup = SolverSetup("bionetflux.problems.organ_on_chip_example")
\end{lstlisting}
...
setup = SolverSetup("bionetflux.problems.ooc_test_problem")
...
def create_solver_setup(problem_module: str = "bionetflux.problems.KS_traveling_wave") -> SolverSetup
\end{lstlisting}
...
setup = quick_setup("bionetflux.problems.test_problem", validate=False)
\end{lstlisting}
...
\begin{todobox}
	\begin{itemize}
		\item \sout{Choose (possibly new) default problem to be used in {\tt \_\_init\_\_}}
