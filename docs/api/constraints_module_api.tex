...
This section provides an exact reference for the constraints module (\texttt{bionetflux.core.constraints}) based on detailed analysis of the actual implementation. The module handles boundary conditions and junction constraints using Lagrange multipliers for HDG methods.
...
\begin{itemize}
    ...
    \item \texttt{positions}: Position (parametric) coordinates in each domain
